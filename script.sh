...
as my_inst_aux.S -o my_inst_aux.o
objcopy -O binary my_inst_aux.o my_inst_aux.bin
hexdump -v -e '"(unsigned char)0x" 1/1 "%02x" ","' my_inst_aux.bin > my_inst_aux.bin.parsed
